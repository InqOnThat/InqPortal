...
It includes a full browser based Admin GUI to
  (1) manage Soft AP and multiple Station access points with full scan for 
  ...
  (4) Customizable, Windows style Task Manager type histogram that can also 
    be used for IoT application custom variables.  
  ...
  (6) Admin provides client starter app generation to kick-start your custom
    customer facing GUI.  Use the built-in Chart.js for graphing or drop in
...
* https://inqonthat.com/inqportal-help/ - Admin context sensative help links.  TBD
